...
export const PublicationCard: FC<PublicationCardProps> = ({ entry }) => {
  return (
    <div
      key={entry.id}
      className="text-black w-full p-2 bg-indigo-100 border-2 border-black rounded-md shadow-sm hover:shadow-md hover:translate-x-0.5 hover:-translate-y-0.5 transition-all"
    >
