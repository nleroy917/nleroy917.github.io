...
export const SoftwareCard: FC<Props> = ({ entry }) => {
  ...
  return (
    <div className="text-black p-2 my-3 transition-all bg-purple-100 border-2 border-black rounded-md shadow-sm hover:shadow-md hover:translate-x-0.5 hover:-translate-y-0.5">
